...
class EarningsQuestion0(Form):
	gender = SelectField('gender', choices=[('m', 'Male'), ('f', 'Female'), ('o', 'Other'), ('n', 'I\'d prefer not to say')], render_kw={"class": "col-md-6"})
	marital_status = SelectField('marital', choices=[('s', 'Single'), ('m', 'Married'), ('d', 'Divorced')], render_kw={"class": "col-md-6"})
